...
exports.finalView = async (req, res) => {
    ...
    console.log(key);
    if (key === "final-view") {
      const filePath = path.join(__dirname, '..','json', 'finalView.json');
...
// exports.finalViewGet = async (req,res) => {
//     // res.json({ Final_View: 'Access' });
//     console.log("hiting get api ");
//     res.status(200).json({ Final_View: 'Access' } );
//     }
//   ;